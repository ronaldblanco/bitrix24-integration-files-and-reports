...
//var_dump(date("Y-m-d h:i:s",strtotime(date("Y-m-d h:i:s") . ' -5 hour')));
...
*/
$codes = array('sp' => 'Only Spanish', 'out' => 'Not Receiving', 'default' => 'Only English', 'adm' => 'Manager', 'ext' => 'Ext. Dep. English', 'ext/sp' => 'Ext. Dep. Spanish');
...
<head>
    <meta charset="UTF-8">
    <title>Contacts Count by User -External Department only-!</title>
...
<body>
	...
	<center><h2 class = "margin-tops">Contacts Count by User -External Department only-</h2>

	<form action="https://crm.api.com/bitrix/admin/dhhdbw73723934dvrgintegration/REPORTS/sakjvblakvb87qwrv9g21cudhb9c8jsdcontacts_count_by_user_by_date4.php" method="POST">
<div class="container">
  <div class="row">
    <div class="col-md-9">
</div>
